                                ...
                                <div class="row">
                                    ...
                                    {{-- <div class="col-md-12 mb-20">
                                        ...
                                        <textarea name="description" id="description" rows="10"
                                            class="form-control radius-8 @error('description') is-invalid @enderror">{{ old('description', $product->description) }}</textarea>
                                        @error('description')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div> --}}
                                    ...
                                    <div class="col-md-12 mb-20">
                                        <label for="category_id"
                                            class="form-label fw-semibold text-primary-light text-sm mb-8">
                                            التصنيف <span class="text-danger-600">*</span>
                                        </label>
                                        ...
                                        <div class="card h-100 p-0">
                                            ...
                                            <div class="card-body p-24">
                                                <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                                    <div
                                                        class="uploaded-img {{ $product->getFirstMediaUrl('products') ? '' : 'd-none' }} position-relative h-120-px w-120-px border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50">
                                                        <button type="button"

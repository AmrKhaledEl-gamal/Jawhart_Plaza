                                        ...
                                        <div class="card h-100 p-0">
                                            ...
                                            <div class="card-body p-24">
                                                <div class="upload-image-wrapper d-flex align-items-center gap-3">
                                                    ...
                                                    {{-- الصورة الحالية / القديمة --}}
                                                    <div
                                                        class="uploaded-img position-relative h-120-px w-120-px border input-form-light radius-8 overflow-hidden border-dashed bg-neutral-50 {{ $category->getFirstMediaUrl('categories') ? '' : 'd-none' }}">
                                                        <button type="button"
                                                        ...
                                                        <img id="uploaded-img__preview" class="w-100 h-100 object-fit-cover"
                                                            src="{{ $category->getFirstMediaUrl('categories') ?: asset('front/images/default-image.png') }}"
                                                            alt="image">
                                                    </div>
